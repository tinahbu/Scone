code
    ...
    (new-indv-role {version of hardware resources} {hardware resources})
    (new-indv-role {brand of hardware resources} {hardware resources})
    ;;;
    ...
    (new-type {Nvidia} {GPU})
    (new-type {AMD} {GPU})
    (new-type {GeForce GTX_1080} {Nvidia})
    (new-type {GeForce GTX_1060} {Nvidia})
    (new-type {GeForce GTX_1050} {Nvidia})
    (new-type {GeForce GTX_980} {Nvidia})
    (new-type {Radeon RX_580} {AMD})
    (new-type {Radeon RX_470} {AMD})
    (new-type {Radeon RX_390} {AMD})
    (new-type {Radeon RX_290} {AMD})
    
    
    ;;; role node of operating system
    (new-indv-role {version of operating system} {operating system})
    ...
    (x-is-the-y-of-z (new-string {"i3"}) {version of hardware resources} {Intel Core CPU_i3})
    (x-is-the-y-of-z (new-string {"i5"}) {version of hardware resources} {Intel Core CPU_i5})
    (x-is-the-y-of-z (new-string {"i7"}) {version of hardware resources} {Intel Core CPU_i7})
    ...
    (x-is-the-y-of-z (new-string {"1080"}) {version of hardware resources} {GeForce GTX_1080})
    (x-is-the-y-of-z (new-string {"1060"}) {version of hardware resources} {GeForce GTX_1060})
    (x-is-the-y-of-z (new-string {"1050"}) {version of hardware resources} {GeForce GTX_1050})
    (x-is-the-y-of-z (new-string {"980"}) {version of hardware resources} {GeForce GTX_980})
    (x-is-the-y-of-z (new-string {"Nvidia GeForce GTX"}) {brand of hardware resources} {GeForce GTX_1080}))
    (x-is-the-y-of-z (new-string {"Nvidia GeForce GTX"}) {brand of hardware resources} {GeForce GTX_1060}))
    (x-is-the-y-of-z (new-string {"Nvidia GeForce GTX"}) {brand of hardware resources} {GeForce GTX_1050}))
    (x-is-the-y-of-z (new-string {"Nvidia GeForce GTX"}) {brand of hardware resources} {GeForce GTX_980}))
    ...
    (x-is-the-y-of-z (new-string {"AMD Radeon RX"}) {brand of hardware resources} {Radeon RX_580}))
    (x-is-the-y-of-z (new-string {"AMD Radeon RX"}) {brand of hardware resources} {Radeon RX_470}))
    (x-is-the-y-of-z (new-string {"AMD Radeon RX"}) {brand of hardware resources} {Radeon RX_390}))
    (x-is-the-y-of-z (new-string {"AMD Radeon RX"}) {brand of hardware resources} {Radeon RX_290}))
    ...
    (defun task_check_user_hardware (user task)
      ;;; check what hardware the task requires software
      (list
    ...
    (show-all-x-of-y {processor of user} {user 6})
